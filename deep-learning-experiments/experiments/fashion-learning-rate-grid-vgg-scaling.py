...
script = "train.py"
description = """
Training FashionMNIST with a simple MLP (no batch norm) on many topologies and many learning rates.
    ...
    for topology in topo_names:
        for learning_rate in np.logspace(start=-7, stop=0, base=2, num=10 + 1):
            ...
            config = {
                **base_config,
                "topology": topology,
                "num_epochs": int(math.ceil(50 * num_workers / 32)),
