...
description = """
New approach to covariance between workers: we repeatedly store the same checkpoint and train for 200 steps. This gives us models across which we can compute covariance.
""".strip()
